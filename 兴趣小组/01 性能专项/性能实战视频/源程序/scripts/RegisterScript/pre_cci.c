# 1 "c:\\documents and settings\\admin\\\327\300\303\346\\books\\books\\registerscript\\\\combined_RegisterScript.c"
...
# 1 "c:\\documents and settings\\admin\\\327\300\303\346\\books\\books\\registerscript\\\\combined_RegisterScript.c" 2
...
# 2 "c:\\documents and settings\\admin\\\327\300\303\346\\books\\books\\registerscript\\\\combined_RegisterScript.c" 2
...
Action()
{
	lr_rendezvous("Í¬Ê±µÇÂ¼×¢²á");

	lr_start_transaction("µÇÂ¼×¢²áÊÂÎñ");
	...
	web_submit_form("login.pl_2",
		...
		"Name=address2", "Value={postcode}", "ENDITEM",
	...
	lr_end_transaction("µÇÂ¼×¢²áÊÂÎñ", 2);

	return 0;
}


# 3 "c:\\documents and settings\\admin\\\327\300\303\346\\books\\books\\registerscript\\\\combined_RegisterScript.c" 2
...
# 4 "c:\\documents and settings\\admin\\\327\300\303\346\\books\\books\\registerscript\\\\combined_RegisterScript.c" 2
