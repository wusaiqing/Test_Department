# 1 "h:\\books\\downloadfilescript\\\\combined_DownloadFileScript.c"
...
# 1 "h:\\books\\downloadfilescript\\\\combined_DownloadFileScript.c" 2
...
# 2 "h:\\books\\downloadfilescript\\\\combined_DownloadFileScript.c" 2
...
Action()
{
	...
	iflen = web_get_int_property(2);

	if(iflen > 0)	
	{
		 
		if((lfbody = fopen("c:\\性能测试实践及其展望.pdf", "wb")) == 0)
		{
...
# 3 "h:\\books\\downloadfilescript\\\\combined_DownloadFileScript.c" 2
...
# 4 "h:\\books\\downloadfilescript\\\\combined_DownloadFileScript.c" 2
