# 1 "d:\\book\\\265\332\266\376\260\346\\scripts\\scriptofsockets\\\\combined_ScriptofSockets.c"
...
# 1 "d:\\book\\\265\332\266\376\260\346\\scripts\\scriptofsockets\\\\combined_ScriptofSockets.c" 2
...
# 2 "d:\\book\\\265\332\266\376\260\346\\scripts\\scriptofsockets\\\\combined_ScriptofSockets.c" 2
...
Action()
{
    LrsCreateSocket("socket0", "TCP", "RemoteHost=yuy:3456",  "0");
    ...
    lr_think_time(48);
    LrsSend("socket0", "buf4", "0");
    LrsReceive("socket0", "buf5", "0");
    lr_think_time(40);
    LrsSend("socket0", "buf6", "0");
    LrsReceive("socket0", "buf7", "0");
    LrsSend("socket0", "buf8", "0");
    LrsReceive("socket0", "buf9", "0");
    LrsSend("socket0", "buf10", "0");
    LrsReceive("socket0", "buf11", "0");
    LrsSend("socket0", "buf12", "0");
    LrsReceive("socket0", "buf13", "0");
    LrsSend("socket0", "buf14", "0");
    LrsReceive("socket0", "buf15", "0");
    LrsSend("socket0", "buf16", "0");
    LrsReceive("socket0", "buf17", "0");
    LrsSend("socket0", "buf18", "0");
    LrsReceive("socket0", "buf19", "0");
    LrsSend("socket0", "buf20", "0");
    LrsReceive("socket0", "buf21", "0");
    LrsSend("socket0", "buf22", "0");
    LrsReceive("socket0", "buf23", "0");

    return 0;
}

# 3 "d:\\book\\\265\332\266\376\260\346\\scripts\\scriptofsockets\\\\combined_ScriptofSockets.c" 2
...
# 4 "d:\\book\\\265\332\266\376\260\346\\scripts\\scriptofsockets\\\\combined_ScriptofSockets.c" 2
